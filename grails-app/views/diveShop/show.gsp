        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-4">
                    <div class="list-group">
                        <g:each in="${allDiveShops}" var="shop">
                            <g:link action="show" id="${shop.id}"
                                    class="list-group-item list-group-item-action ${(diveShop.id==shop.id?'active':'')}">
                                ${shop.name}
                            </g:link>
                        </g:each>
                    </div>
                ...
                <div class="col-8">
                    <div class="card">
                        <div class="card-body">
                            <g:uploadForm controller="diveShop" action="update" >
                                <g:hiddenField name="id" value="${diveShop.id}" />
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="card" style="width: 18rem;">
                                            <g:if test="${image2Exist}">
                                                <img src="${createLink(action:"showImage2", id: diveShop.id)}"
                                                     class="card-img-top" alt="thumbnail-2">
                                            </g:if>
                                            <g:else>
                                                <asset:image src="dummy.jpg" />
                                            </g:else>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <g:textField name="features" value="${features}" placeholder="Enter something" class="form-control"/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="courses" class="col-sm-2 col-form-label">Courses</label>
                                    <div class="col-sm-10">
                                        <g:textField name="courses" value="${courses}" placeholder="Enter something" class="form-control"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-10">
                                        ...
                                        <g:link action="display" id="${diveShop.id}" class="btn btn-outline-primary">
                                            Display
                                        </g:link>
                                    </div>
                                </div>
